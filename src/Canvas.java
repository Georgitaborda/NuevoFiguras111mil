...
public class Canvas
{
    ...
    */
     ...
     */
    public void rellenarRectangulo(int xPos, int yPos, int lado1, int lado2)
    {
        rellenar(new Rectangle(xPos, yPos, lado1, lado2));
    }
     ...
     *  Podr�a utilizarse tambi�n el m�todo borrar para esta tarea.
     */
    public void borrarRectangulo(int xPos, int yPos, int lado1, int lado2)
    {
        borrar(new Rectangle(xPos, yPos, lado1, lado2));
    }
